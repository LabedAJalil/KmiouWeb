                                        ...
                                        <div class="auth-content">
                                            <div class="card">
                                                <div class="card-body text-center">
                                                 <form method="POST" action="{{ route('shipperChangePassword') }}">
                                                        @csrf
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="password" minlength="8" name="new_password" class="form-control" required="" placeholder="New Password">
                                                    </div>
