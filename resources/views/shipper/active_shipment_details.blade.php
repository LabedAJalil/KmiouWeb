...
@section('main-content')
 ...
 <main>
                                ...
                                <div class="hero-cap">
                                    @if($details[0]['status'] == '0')
                                        ...
                                        @if($details[0]['quotation_type'] == '0')
                                            ...
                                            <h2>Bidded Shipment Details</h2>

                                        @elseif($details[0]['quotation_type'] == '1')
                                            
                                            <h2>Fixed Shipment Details</h2>

                                        @elseif($details[0]['status'] == "0" && $details[0]['transporter_id'] = "0" && $details[0]['driver_id'] = "0" && $details[0]['bid_status'] = "0" AND $details[0]['quotation_type'] = "0" )
                                            
                                            <h2>Received Offers Shipment Details</h2>   
                                    ...
                                    @elseif($details[0]['status'] == '1')
                                        <h2>Accepted Shipment Details</h2>
                                    @else
                                            ...
                                            <div class="card-info-shipp">
                                                ...
                                                <div class="drop-info">
                                                    ...
                                                    @if($details[0]['status'] == '0')
                                                        ...
                                                        @if($details[0]['quotation_type'] == '0')
                                                            ...
                                                            @endif
                                                        @else
                                                            <p class="pending-lab pick-p" style="color:#FFC70D"> Waiting for Acceptance </p>
                                                        @endif
                                                ...
                                                @if($details[0]['status'] == '0' || $details[0]['status'] == '1' || $details[0]['status'] == '4')
                                                    ...
                                                    <div class="full-width text-center">
                                                        <a data-toggle="modal" data-target="#exampleModalCentercan" href="javascript:void(0);" class="btn btn-danger mb-4">Cancel Shipment</a>
                                                    </div>
                                                @endif
               ...
               @foreach($bid as $bid)
                <div class="col-md-12 driv-block">
                    ...
                    @if($details[0]['bid_status'] == '0')
                        ...
                        <p class="pick-p total-lab marg-bid-rate"  style="padding-top:20px;">{{$bid->bid_amount}} DA</p>
    ...
    <!---credit card Modal -->
    <div class="modal fade" id="exampleModalCreditCard" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            <div class="row">
                <div class="col-md-12 driv-block">
                    ...
                    <form method="POST" id="payment_form" action="{{ route('shipperSelectBidder') }}" enctype="multipart/form-data">
                    @csrf
                        <input type="hidden" name="bid_id" id="bid_id" value="0">
                        <input type="hidden" name="shipment_id" id="shipment_id" value="{{$details[0]['shipment_id']}}">
                        <div class="col-md-12 driv-block">  <img src="{{asset('public/images/visa.png')}}" style="height: 45px;width: 50px;" > 
                        ****-****-****-8246 
                            <input type="checkbox"class="canc-check" required="" name="card_id" value="1">
                        </div>
                        <div class="col-md-12 driv-block">  <img src="{{asset('public/images/visa.png')}}" style="height: 45px;width: 50px;" > 
                        ****-****-****-9135 
                            <input type="checkbox"class="canc-check" name="card_id" value="2">
                        </div>
                        <div class="col-md-12 driv-block">  <img src="{{asset('public/images/visa.png')}}" style="height: 45px;width: 50px;" > 
                        ****-****-****-5483 
                            <input type="checkbox"class="canc-check" name="card_id" value="3">
                        </div>
                        <div class="col-md-12 driv-block">  <img src="{{asset('public/images/visa.png')}}" style="height: 45px;width: 50px;" > 
                        ****-****-****-3753 
                            <input type="checkbox"class="canc-check" name="card_id" value="4">
                        </div>
                    </form>
                    </div>

            <a href="javascript:void(0);" class="btn btn-primary mb-4 float-right" style="margin-top: 20px;margin-right: 100px;" onclick="check_payment_modal(); return;">Proceed to pay</a>
                </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <!-- <div class="input-group mb-3">
                ...
                <form method="POST" id="cancel_form" action="{{ route('shipperCancelShipment') }}" enctype="multipart/form-data">
                @csrf
            <div class="row">
                    <input type="hidden" name="shipment_id" value="{{$details[0]['shipment_id']}}" >
                    
                    <div style="margin-top: 15px" class="col-md-12">
                        <label> Reason For Cancel Shipment </label>
...
<script type="text/javascript">
        ...
        $('.get_bid_id').click(function() {
            
            var bid_id = $(this).data('bid_id');
           
            $('#bid_id').val(bid_id);
            
            var payment_type = "{{$details[0]['payment_type']}}";

            if(payment_type == '1'){
            
                $('#exampleModalCreditCard').modal('show');
        ...
        $(document).on("change","#truck_filter_type",function(){
            ...
            window.location = '{{url("/shipper/shipment/active")}}/'+ship_id+'/details';
        });
