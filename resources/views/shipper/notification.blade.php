                                    ...
                                    <div class="card Recent-Users">
                                        <div class="card-block px-0 py-3">
                                            ...
                                            @if($notification_list != null && $notification_list != '[]')   
                                                ...
                                                @if($value['noti_type'] == '2' || $value['noti_type'] == '5' || $value['noti_type'] == '6' || $value['noti_type'] == '9' )

                                                    <a href="{{route('shipperShowActiveShipmentDetails',array('id'=>$value['ref_id']))}}">
                                                   
                                                @elseif($value['noti_type'] == '7')
                                                    
                                                    <a href="{{route('shipperShowCancelShipmentDetails',array('id'=>$value['ref_id']))}}">
                                                
                                                @elseif($value['noti_type'] == '8')
                                                    
                                                    <a href="{{route('shipperShowReportShipmentDetails',array('id'=>$value['ref_id']))}}">
                                                    
                                                @elseif($value['noti_type'] == '13')
