                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="bs-tether-element-attached-bottom-cap">
                                <div class="hero-cap">
                                    <h2>Cancelled Shipment Details</h2>
                                </div>
                                        ...
                                        <div class="card-block px-0 py-3">
                                            <div class="card-info-shipp">
                                                ...
                                                <div class="drop-info">
                                                    ...
                                                    <p class="pending-lab pick-p disp-cont" style="color:#ed3709">Cancelled
                                                    </p>
                                                </div>
                                                ...
                                                <div class="drop-info">
                                                    <label class="det-label">Cancel Reason: </label>
                                                    <p class="pending-lab pick-p disp-cont" style="color:red">
                                                        @if($details[0]['cancel_reason'] == '0')
                                                        Accident
                                                        @elseif($details[0]['cancel_reason'] == '1')
                                                        Engine Problem
                                                        @elseif($details[0]['cancel_reason'] == '2')
                                                        Fuel Over
                                                        @elseif($details[0]['cancel_reason'] == '3')
                                                        Medical Emergency
                                                        @else
                                                        Other
                                                        @endif
                                                ...
                                                <div class="drop-info">
                                                    <label class="det-label">Cancel Comment: </label>
                                                    <p class="pending-lab pick-p disp-cont" style="color:red">
                                                        {{$details[0]['cancel_comment']}}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
        ...
        $(document).on("change","#truck_filter_type",function(){
            ...
            window.location = '{{url("/shipper/shipment/cancel")}}/'+ship_id+'/details';
        });
