            ...
            <div class="container">
                <div class="main-body">
                        <div class="page-wrapper">
                            ...
                            @if($cancel_list != null && $cancel_list != '[]') 
                                    ...
                                    <div class="card Recent-Users">
                                        <div class="card-block px-0 py-3">
                                            <div class="card-info-shipp mt-15">
                                                ...
                                                <div class="view-more">
                                                    <a href="{{route('shipperShowCancelShipmentDetails',array('id'=>$value['shipment_id']))}}">View More</a>
                            ...
                            @endforeach
                            @else
                                <h2> Cancel Shipment List Is Empty </h2>
                            @endif
                            </div>
                            <!-- [ Main Content ] end -->
                        </div>
