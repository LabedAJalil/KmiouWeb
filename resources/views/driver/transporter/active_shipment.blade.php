...
<script type="text/javascript">
  $(document).ready(function(){  
        ...
        $("#filter_type ,#arriving_city ,#departing_city").change(function() {  
        ...
        function ActiveShipmentFilter(){
            ...
            $.ajax({
                ...
                type:"POST",
                data:{'_token':"{{csrf_token()}}",filter_type:filter_type,arriving_city:arriving_city,departing_city:departing_city},
