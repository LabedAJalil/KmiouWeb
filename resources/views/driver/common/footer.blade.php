<footer>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                <h4>Open hour</h4>
                                <ul>
                                    <li><a href="javascript:void(0);">Monday 11am-7pm</a></li>
                                    <li><a href="javascript:void(0);"> Tuesday-Friday 11am-8pm</a></li>
                                    <li><a href="javascript:void(0);"> Saturday 10am-6pm</a></li>
                                    <li><a href="javascript:void(0);"> Sunday 11am-6pm</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                ...
                                <ul>
                                    ...
                                    <li><a href="javascript:void(0);"> Heal Insurance</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                        <div class="single-footer-caption mb-50">
                            ...
                            <div class="footer-logo">
                                <a href="javascript:void(0);"><img src="{{asset('public/img/logo/logo2_footer.png')}}" alt=""></a>
                            </div>
                            <div class="footer-tittle">
  ...
  Copyright © 2020 KMIOU, All rights reserved.
...
<div id="back-top" >
    ...
    <!-- for translate page into multiple languages -->
