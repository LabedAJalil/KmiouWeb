                                    ...
                                    <div class="card Recent-Users">
                                        <div class="card-block px-0 py-3">
                                            ...
                                            @if($notification_list != null && $notification_list != '[]')
                                                ...
                                                @if($value['noti_type'] == '1' || $value['noti_type'] == '3')
                                                
                                                    <a href="{{route('driverShowShipmentRequestDetails',array('id'=>$value['ref_id']))}}">
                                                
                                                @elseif($value['noti_type'] == '14' || $value['noti_type'] == '15')

                                                    <a href="javascript:void(0);" data-shipment_id="{{$value['ref_id']}}" id="pickup_noti_type" >

                                                @elseif($value['noti_type'] == '7')
                                                    <a href="{{route('driverShowCancelShipmentDetails',array('id'=>$value['ref_id']))}}">
                                                @else
                                                    
                                                    <a href="{{route('driverShowActiveShipmentDetails',array('id'=>$value['ref_id']))}}">
