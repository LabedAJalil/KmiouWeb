                ...
                <div class="pcoded-inner-content">
                 <div class="row">
                        ...
                        <div class="col-md-6 text-right content-header">
                            <a href="{{route('showAddNewTruck')}}" type="button" class="btn btn-raised btn-primary btn-min-width mr-1 mb-1"><i class="fa fa-user-o" style="margin-right: 10px;"></i>Add New Truck</a>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title" style="display: inline-block;"> Truck List</h4>
                                                        ...
                                                        <td>
                                                          <?php
                                                            $doc = array();
                                                             ...
                                                             if($data->truck_img != '' && $data->truck_img != null){
...
<script type="text/javascript">
   ...
   $(document).on("click",".remove_truck",function(){
          ...
          var click = $(this);
          var truck_id = click.data('truck_id');
          if(confirm("Are You sure you want to remove truck ?"))
          {
              $.ajax({
                   type:"POST",
                   url:'{{route("removeTruck")}}',
                   data : {
                   "_token": "{{ csrf_token() }}",
                    "truck_id": truck_id},
                   success:function(data){
