                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title" style="display: inline-block;">Available Drivers</h4>
                                                ...
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if($data->ref_id == 0) Singal Driver @else Associate Driver @endif
                                                        ...
                                                        @if($data->approve == '0')
                                                          ...
                                                          @endif
                                                          <!-- {{ $data->approve == 0 ? 'Pending' : ($data->approve == 1 ? 'Approved' : 'Not Approved') }} -->
                                                        </td>
                                                        <td>
...
$(function(){
      $('#approve_status').on('change', function () {
          ...
          if(id){
            window.location = "{{route('driverUserList')}}/0/" + id;
          }
          return false;
      });
    });
