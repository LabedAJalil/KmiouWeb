                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title" style="display: inline-block;">Reported Shipment List</h4>
                                            ...
                                            <table class="table table-responsive table-striped table-bordered file-export" id="users_datatable"  style="width: 100% !important;">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('showReportedShipmentDetails',array('id'=>$data->id))}}" class="" data-id="{{$data->id}}">View More</a>&nbsp;
                                                         </td>
