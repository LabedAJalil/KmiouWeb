                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title" style="display: inline-block;">Cancelled Shipment List</h4>
                                            ...
                                            <table class="table table-striped table-responsive table-bordered file-export" id="users_datatable"  style="width: 100% !important;">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('showCancelledShipmentDetails',array('id' => $data->id))}}" class="" data-id="{{$data->id}}">View More</a>&nbsp;
                                                         </td>
