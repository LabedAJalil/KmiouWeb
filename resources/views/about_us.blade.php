...
@section('content')
 ...
 <main>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption mb-50">
                            ...
                            <div class="section-tittle mb-35">
                                ...
                                <h2>Kmiou is a leading</h2>
                            </div>
                            <p> freight forwarder offering shippers access to a connected fleet of thousands of trucks. By leveraging our inhouse technology, we build an environment that leads the trucking and freight businesses into a high level of security, transparency, efficiency and flexibility To Land transportation market, which until now has been dependent on paper, phone and fax and characterized by multi-level subcontracting. Kmiou digital platform has unlimited capacities, at any time of the day. Kmiou digitalizes the transportation by providing mobile apps to drivers, fleet management system to fleet managers and logistics management solutions to shippers. Real-time booking, a designated contact person 24/7, as well as live tracking, bring full transparency to all shipments. By integrating directly with the shippers’ Transport Management and Freight Management Systems via APIs and by removing the multiple intermediary layers, Kmiou increases efficiency and reduces cost for all stakeholders.</p>
        ...
        <!-- About Area End -->
        <!--? contact-form start -->
<!--         <section class="contact-form-area section-bg  pt-115 pb-120 fix" data-background="{{asset('public/img/gallery/section_bg02.jpg')}}">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="single-team mb-30 text-center">
                            <div class="team-img">
                                <img src="{{asset('public/img/gallery/team1.png')}}" alt="">
                                <div class="team-caption">
                                    <h3><a href="javascript:void(0);">Mancherwan Kolin</a></h3>
                                    <p>Health agent</p>
                                    <!-- Blog Social -->
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="single-team mb-30 text-center">
                            <div class="team-img">
                                <img src="{{asset('public/img/gallery/team2.png')}}" alt="">
                                <div class="team-caption">
                                    <h3><a href="javascript:void(0);">Mancherwan Kolin</a></h3>
                                    <p>Health agent</p>
                                    <!-- Blog Social -->
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="single-team mb-30 text-center">
                            <div class="team-img">
                                <img src="{{asset('public/img/gallery/team3.png')}}" alt="">
                                <div class="team-caption">
                                    <h3><a href="javascript:void(0);">Mancherwan Kolin</a></h3>
                                    <p>Health agent</p>
                                    <!-- Blog Social -->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="home-blog-single mb-30">
                            ...
                            <div class="blog-caption">
                                ...
                                <div class="blog-cap">
                                    <ul>
                                        <li><a href="javascript:void(0);"><i class="ti-user"></i> Jessica Temphers</a></li>
                                        <li><a href="javascript:void(0);"><i class="ti-comment-alt"></i> 12</a></li>
                                    </ul>
