...
<p style="font-size: 34px; line-height: 1.5; text-align: center; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; word-break: break-word; mso-line-height-alt: 51px; margin: 0;"><span style="font-size: 34px; color: #339966;"><strong><span style="font-size: 34px;"><span style="font-size: 34px;"> Hello ADMIN,</span></span></strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 18px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 22px; margin: 0;"><span style="font-size: 18px; color: #ffffff;"> NEW <b> {{$user->user_type}} </b> User Registered In KMIOU <br> <br> <b> User Name </b> : {{$user->user_name}} <br> <b> Email </b> : {{$user->email}} <br> <b> Register Date </b> : {{$user->date}} </span></p>
</div>
</div> 
