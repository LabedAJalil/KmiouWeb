                            ...
                            <ul class="navbar-nav ml-auto col-md-3 text-right" style="float:right">
                                 <li>
                                    <select class="form-control" style="margin-bottom: 15px;" id="filter_type">
                                            ...
                                            <option value="1" <?php if($filter_type == '1'){echo "selected";} ?> >Past Shipment</option>
                                            <option value="2"  <?php if($filter_type == '2'){echo "selected";} ?> >Cancelled Shipment</option>
                             ...
                             <ul class="navbar-nav ml-auto col-md-3 text-right">
                                 ...
                                 <li>
                                     <input type="date" class="form-control" placeholder="Select From Date" name="from_date" value="{{date('d-m-Y')}}" id="from_date" style="margin-bottom: 15px;">
                                </li>
                            </ul>
...
<script type="text/javascript">
  $(document).ready(function(){  
        ...
        function RequestListFilter(){
            ...
            $.ajax({
                url:"{{route('transporterPastShipmentListFilter')}}",
                type:"POST",
