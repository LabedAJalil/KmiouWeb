                                        ...
                                        <div class="card-block px-0 py-3">
                                            <div class="card-info-shipp">
                                                ...
                                                <div class="drop-info">
                                                    ...
                                                    <p class="cancel-lab pick-p" style="color:#EF5163;">
                                                    Reported
                                                    </p>
                                                </div>
                                                <div class="drop-info">
                                                ...
                                                <div class="drop-info">
                                                    <label class="det-label">Reported Comment: </label>
                                        ...
                                        <div class="card-block px-0 py-3">
                                            <div class="card-info-shipp">
                                                ...
                                                <div class="invoice-info">
                                                    ...
                                                    <p class="pick-p total-lab">{{$details[0]['total_amount']}}ع.د </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
        ...
        $(document).on("change","#truck_filter_type",function(){
              ...
              window.location = '{{url("/transporter/shipment/report")}}/'+ship_id+'/details';
          });
