                                ...
                                <ul class="navbar-nav ml-auto col-md-3 text-right" style="float: right;">
                                     <li>
                                        ...
                                        style="margin-bottom: 15px;>
                                                ...
                                                <option value="2" <?php if($filter_type != '1'){
                                                    echo("selected");} ?> >Active Shipments</option>
                                 ...
                                 <ul class="navbar-nav ml-auto col-md-3 text-right">
                                    ...
                                    <li>    
                                        <input type="date" class="form-control" placeholder="Select From Date" onload="(this.value)" value="{{date('Y-m-d')}}" name="from_date" id="from_date" style="margin-bottom: 15px;">
                                    </li>
                                </ul>
...
<script type="text/javascript">
  $(document).ready(function(){  
        ...
        function ActiveShipmentFilter(){
            ...
            $.ajax({
                url:"{{route('transporterActiveShipmentFilter')}}",
                type:"POST",
                    ...
                    if(res.success == '1'){
                        ...
                        if(res.result.length >0){
                            ...
                            $.each(res.result, function( k, v ) {
                                ...
                                $('.active_shipment_list').append('<div class="col-md-4"> <div class="page-header-title"> <h5 class="m-b-10">Shipment ID : '+v.ship_id+'</h5> </div> <div class="card Recent-Users"> <div class="card-block px-0 py-3"> <div class="card-info-shipp"> <div class="user-img"> <img class="user-logo" '+profile_pic+' > <p class="user-name">'+v.shipper_first_name+' '+v.shipper_last_name+'</p> <p class="book-date">'+v.created_at+' </p> <div class="pickup-info"> <p> '+v.amount+' DA</p> </div> <br> <p class="pending-lab pick-p disp-cont"> '+status+' </p> </div> <div class="pickup-info"> <i class="fas fa-circle text-c-green f-10 m-r-15"></i>Pickup Location <p class="pick-p">'+v.pickup+'</p> </div> <div class="drop-info"> <i class="fas fa-circle text-c-red f-10 m-r-15"></i>Drop Location <p class="pick-p">'+v.drop+'</p> </div> <div class="view-more"> <a href="{{url("/transporter/shipment/active")}}/'+v.shipment_id+'/details">View More</a> </div> </div> </div> </div> </div>');
